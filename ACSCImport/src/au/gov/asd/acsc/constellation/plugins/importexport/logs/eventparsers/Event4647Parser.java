...
public class Event4647Parser extends EventTypeParser {

    private static final Logger LOGGER = Logger.getLogger(Event4647Parser.class.getName());

    public Event4647Parser() {
        super("4647 - User initiated logoff", 2);
    }
    ...
    public void parse(Element input, RecordStore results, PluginParameters parameters) throws IOException {
        ...
        results.set(GraphRecordStoreUtilities.TRANSACTION + AnalyticConcept.VertexAttribute.TYPE, "User initiated logoff");
