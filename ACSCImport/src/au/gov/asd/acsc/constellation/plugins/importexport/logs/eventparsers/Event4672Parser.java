...
public class Event4672Parser extends EventTypeParser {

    private static final Logger LOGGER = Logger.getLogger(Event4672Parser.class.getName());

    public Event4672Parser() {
        super("4672 - Special Privileges assigned to new logon", 2);
    }
    ...
    public void parse(Element input, RecordStore results, PluginParameters parameters) throws IOException {
        ...
        String privList = dataPoints.getOrDefault("PrivilegeList","Unknown");
        ...
        results.set(GraphRecordStoreUtilities.TRANSACTION + AnalyticConcept.VertexAttribute.TYPE, "Special privileges assigned to new logon");
        ...
        results.set(GraphRecordStoreUtilities.TRANSACTION + "Privilege List", privList);
